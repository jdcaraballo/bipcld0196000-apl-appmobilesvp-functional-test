...
public class EditarFavoritoRecargas implements Task {

  private Recargas datosModificadosFavorito;

  public EditarFavoritoRecargas(Recargas transaccion) {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
        ...
        Limpiar.campo(TXT_NUMERO_PRODUCTO),
