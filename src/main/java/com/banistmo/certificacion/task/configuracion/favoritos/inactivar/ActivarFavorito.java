...
public class ActivarFavorito implements Task {

  public static ActivarFavorito inactivo() {
    return instrumented(ActivarFavorito.class);
  }
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
        Editar.favoritoInactivo(nombreFavorito.getProducto().getDescripcion()),
