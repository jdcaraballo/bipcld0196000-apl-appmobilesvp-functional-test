...
import static com.banistmo.certificacion.userinterface.menu.MenuConfiguracionPage.BTN_OPT_CONFIGURACION;
...
public class IngresarAConfiguracion implements Task {

  private final String opcionMenu;
  private final Target opcionConfiguracion;

  public IngresarAConfiguracion(String opcionMenu, Target opcionConfiguracion) {
    this.opcionMenu = opcionMenu;
    this.opcionConfiguracion = opcionConfiguracion;
  }

  public static IngresarAConfiguracion deSeguridad(String submenu, Target opcionSubmenu) {
    return instrumented(IngresarAConfiguracion.class, submenu, opcionSubmenu);
  }
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
            ...
            EsperarElemento.esVisible(LBL_DEPOSITOS),
            EsperarElemento.esClickable(BTN_CONFIGURACION),
            Click.on(BTN_CONFIGURACION),
            EsperarElemento.esClickable(BTN_OPT_CONFIGURACION.of(opcionMenu)),
            Click.on(BTN_OPT_CONFIGURACION.of(opcionMenu)),
            EsperarCarga.desaparezca(),
