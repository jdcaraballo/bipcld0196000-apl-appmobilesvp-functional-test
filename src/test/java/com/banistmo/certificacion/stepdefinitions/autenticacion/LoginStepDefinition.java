...
import static com.banistmo.certificacion.userinterface.PrincipalPage.BTN_VISTA_LISTA;
...
public class LoginStepDefinition {
  ...
  public void verificarVisibilidadProductos() {
    theActorInTheSpotlight().should(seeThat(ElementoEsperado.esVisible(
            BTN_VISTA_LISTA.waitingForNoMoreThan(Duration.ofSeconds(10))))
  ...
  public void verificarVisibilidadProductosCambioDeContrasenia(String contrasenaActual, String contrasenaNueva) {
    theActorInTheSpotlight().should(seeThat(ElementoEsperado.esVisible(
            BTN_VISTA_LISTA.waitingForNoMoreThan(Duration.ofSeconds(10))))
                .orComplainWith(MenuSvpNoVisualizadoException.class, MENU_VALIDACION_NO_ENCONTRADO));
  }
